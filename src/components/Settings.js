...
class SettingsForm extends React.Component {
  ...
  assignTeam() {
    ...
    if (this.props.currentUser.username === 'leah_kochendoerfer') {
      Object.assign(this.state, {
        teammate1: 'jash_vora',
    ...
    if (this.props.currentUser.username === 'john_melizanis') {
      Object.assign(this.state, {
        teammate1: 'daniel_yee',
        teammate2: 'francesca_ledesma',
    ...
    if (this.props.currentUser.username === 'vimala_veera') {
      Object.assign(this.state, {
        teammate1: 'evelyn_mwangi',
        teammate2: 'lucie_kresl',
    ...
    if (this.props.currentUser.username === 'sunny_zhang') {
      Object.assign(this.state, {
        teammate1: 'raja_riahi',
        teammate2: 'charlie_lu',
        teammate3: 'allison_arvin',
        teammate4: 'ivan_centurion',
      });
    }
    if (this.props.currentUser.username === 'raja_riahi') {
      Object.assign(this.state, {
    ...
    if (this.props.currentUser.username === 'charlie_lu') {
      Object.assign(this.state, {
        teammate1: 'sunny_zhang',
        teammate2: 'raja_riahi',
        teammate3: 'allison_arvin',
        teammate4: 'ivan_centurion',
      });
    }
  ...
  onClick(){
    window.open("https://hbsp.harvard.edu/coursepacks", '_blank');
}
    ...
    return (
      <form onSubmit={this.submitForm}>
        <fieldset>
          ...
          <div style={styles}><p>**remember to change your password from the original threesixty!</p></div>
